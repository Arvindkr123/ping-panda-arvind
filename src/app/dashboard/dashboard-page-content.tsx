    ...
    return (
        <>
                    ...
                    >
                        ...
                        <div className="relative p-6 z-10">
                            ...
                            <div className="flex items-center justify-between mt-4">
                                <Link className={buttonVariants({ variant: 'outline', size: 'sm', className: 'flex items-center gap-2 text-sm' })} href={`/dashboard/category/${category.name}`}>View all <ArrowRight className='size-4' /></Link>
                                <Button variant={'ghost'} size={'sm'} className='text-gray-500 hover:text-red-600 transition-colors' aria-label={`Delete ${category.name} category`} onClick={() => setDeleteCategory(category.name)}><Trash2 className='size-5' /></Button>
                            </div>
                        </div>
                    </li>
                ))}
            ...
            <Modal
                ...
                setShowModal={() => setDeleteCategory(null)}
