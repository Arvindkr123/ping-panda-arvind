    ...
    return (
        <div className='flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl'>
            ...
            <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
                <div className="size-12 bg-discord-brand-color rounded-2xl flex items-center justify-center mb-2 hover:rounded-xl transition-all duration-200 cursor-pointer">
                ...
                <div className='mt-auto group size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-[#3ba55c] cursor-not-allowed'>
                    <PlusCircle className='text-[#3ba55c] group-hover:text-white' />
                </div>
            </div>

            {/* DM list (Direct Message Lists) start*/}
            <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
                <div className="px-4 h-16 border-b border-[#202225] flex items-center shadow-sm">
                    <div className="bg-[#202225] w-full text-sm rounded px-2 h-8 flex items-center justify-center text-gray-500 cursor-not-allowed">
                ...
                <div className="flex-1 overflow-y-auto pt-4">
                    ...
                    <div className="px-2 mb-4">
                        <h3 className="text-sm  font-semibold text-[#8e9297] px-2 mb-2 uppercase">Direct Message</h3>

                        <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
                            <Image src={'/brand-asset-profile-picture.png'} width={32} height={32} className='object-cover rounded-full mr-3' alt='pingPanda Avatar' />
                        ...
                        <div className="my-1 space-y-px">
                            {
                                [...Array(7)].map((_, i) => {
                                    return <div key={i} className='flex items-center px-2 py-1.5 rounded text-gray-600 cursor-not-allowed'>
                ...
                <div className="p-2 bg-[#292b2f] flex items-center">
                    ...
                    <div className="flex-1">
                        ...
                        <p className='text-xs text-[#b9bbbe] flex items-center'>@your account</p>
                    </div>
            ...
            {/* DM list (Direct Message Lists) end*/}
            ...
            <div className="flex-1 flex flex-col ">
                ...
                <div className="h-16 bg-[#36393f] flex  items-center px-4 shadow-sm border-b border-[#202225]">
                    ...
                    <div className="flex items-center">
                        <div className="relative">
                            <Image src={'/brand-asset-profile-picture.png'} width={40} height={40} className='object-cover rounded-full mr-3' alt='pingPanda Avatar' />
                ...
                <div className="p-4">
                    <div className="flex items-center bg-[#40444b] rounded-lg p-1">
                        ...
                        <input type='text' readOnly placeholder='Message @pingPanda' className='flex-1 bg-transparent py-2.5  px-1 placeholder-[#72767d] focus:outline-none cursor-not-allowed'/>
