    ...
    <div className="bg-brand-25 py-24 sm:py-32">
      <MaxWidthWrapper>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-base/7 text-gray-600 mx-auto max-w-prose text-center text-pretty">
        ...
        <div className="bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
                ...
                <p className="mt-6 text-base/7 text-gray-600">
                    Invest once in PingPanda and transform how you monitor your SasS
                 ...
                 lg:py-16">
                    <div className="mx-auto max-w-xs py-8">
                        ...
                        <p className="mt-6 flex items-baseline justify-center gap-x-2">
                            <span className="text-5xl font-bold tracking-tight text-gray-900">RS 200</span>
                            <span className="text-sm font-semibold leading-6 tracking-wide text-gray-600">IND</span>
                        </p>

                        <Button onClick={handleGetAccess} className='mt-6 px-20'>Get PingPanda</Button>
